...
class BitwardenBasic(unittest.TestCase):
    def setUp(self) -> None:
        (
            ...
            self.test_colls_ids,
        ) = bitwarden.get_organization_collections_dicts(test_organization)
        ...
        self.test_coll_1_cipher = bitwarden.get_organizations_collection_items(
            test_organization, self.test_colls_names.get("1_cipher")[0].get("Id")
        )
        self.test_coll_2_ciphers = bitwarden.get_organizations_collection_items(
            test_organization, self.test_colls_names.get("2_ciphers")[0].get("Id")
        )
        self.test_coll_1_user = bitwarden.get_users_of_collection_raw(
            test_organization, self.test_colls_names.get("1_user")[0].get("Id")
        )
        self.test_coll_2_users = bitwarden.get_users_of_collection_raw(
            test_organization, self.test_colls_names.get("2_users")[0].get("Id")
        )
    ...
    def test_create_delete_collection(self):
        _, old_colls_ids = bitwarden.get_organization_collections_dicts(
            test_organization
        )
    ...
    def test_set_users_of_collection(self):
        bitwarden.set_users_of_collection(
            test_organization,
        ...
        self.assertEqual(
            len(
                bitwarden.get_users_of_collection_raw(
                    test_organization, self.test_colls_names.get("1_user")[0].get("Id")
                )
            ),
            2,
    ...
    def test_add_remove_collection_from_user(self):
        ...
        user_infos = bitwarden.get_organization_user_details(
            test_organization, user_org_id
        )
        bitwarden.remove_collections_to_user(
            test_organization,
            user_org_id,
            user_infos,
            [self.test_colls_names.get("1_user")[0].get("Id")],
        ...
        bitwarden.add_collection_to_user(
            test_organization,
            self.test_colls_names.get("1_user")[0].get("Id"),
            user_org_id,
            user_infos,
